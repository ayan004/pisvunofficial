...
(function(element){
    ...
    <div class='noteCard my-2 mx-2 card' style='width: 18rem;'>
        <div class='card-body'>
            <h5 class='card-title'>Notice No: `+element[0]+`</h5>
            <p class='card-text'><h3>`+element[1]+`</h3></p>
...
if($_POST)
{
    ...
    else
    {
        ...
        session_start();
        {
            $_SESSION["noticeNo"]=$_POST['delete'];
            $_SESSION["heading"]=$r['heading'];
            $_SESSION["notice"]=$r['notice'];
            header("location:/pisv/delConfirmNotice.php");
        }
    }
}
